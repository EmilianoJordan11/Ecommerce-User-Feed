...
public class FeedController {
    ...
    ) throws UnauthorizedError, BadRequestError {
        // Validar que el usuario esté autenticado
        User user = tokenService.getUser(authHeader);
        
        // Crear el feed con el userId del token (se valida orden y artículo en el servicio)
        FeedDTO feed = feedService.createFeed(dto, user.id, authHeader);
